/*****************************************************************************************
 ...
 Purpose:        Create Intermediate ADaM Laboratory Dataset (ADINT_LB)
                 Based on SDTM LB split domains from PHUSE Test Data Factory (TDF_SDTM)

 Inputs:         lbch.xpt, lbhe.xpt, lbur.xpt  (Laboratory split domains)
                 dm.xpt                        (Demographics)
                 ex.xpt                        (Exposure – for TRTSDT)
                 sv.xpt                        (Subject Visits – for windowing)

 Output:         adint_lb.sas7bdat
